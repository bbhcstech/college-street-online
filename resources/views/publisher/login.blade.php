...
<div class="a-card" style="max-width:400px;width:100%;">
    ...
    <p style="text-align:center;margin:18px 0 0;">Want to sell books? <a href="{{ route('publisher.register') }}" style="color:var(--a-primary);font-weight:700;">Apply as Publisher</a></p>
</div>
</div>
</body></html>
