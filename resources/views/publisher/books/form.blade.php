...
@section('nav')
    ...
    <div class="nav-group">
        ...
        <a href="{{ route('publisher.books.index') }}" class="nav-link active"><span
                class="nav-icon">&#128214;</span><span>My Books</span></a>
        <a href="{{ route('publisher.inventory.index') }}" class="nav-link"><span
