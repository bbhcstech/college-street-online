    ...
    <section class="account-section" style="padding: 0 0 40px 0;">
        <div class="container">
            ...
            <div class="support-grid">
                ...
                <div class="support-card-form" style="background:#ffffff; border:1px solid var(--border, #e2e8f0); border-radius:14px; padding:22px; box-shadow:0 4px 16px rgba(0,0,0,0.03); height:fit-content;">
                    <div style="display:flex; align-items:center; gap:12px; margin-bottom:18px; padding-bottom:12px; border-bottom:1px solid #f1f5f9;">
                        <div style="width:40px; height:40px; border-radius:10px; background:color-mix(in srgb, var(--brand-primary, #1e3a8a) 10%, #ffffff); display:grid; place-items:center; font-size:1.2rem; color:var(--brand-primary, #1e3a8a);">
                            💬
                        </div>
                        <div>
                ...
                <div class="support-card-history">
                    ...
                    @forelse($tickets as $ticket)
                        <article style="background:#ffffff; border:1px solid var(--border, #e2e8f0); border-radius:12px; padding:18px; margin-bottom:14px; box-shadow:0 2px 8px rgba(0,0,0,0.02); transition:transform 0.15s ease;">
                            ...
                            <p style="margin:8px 0 0 0; font-size:0.86rem; color:var(--text-secondary); line-height:1.5; background:#f8fafc; padding:10px 14px; border-radius:8px; border:1px solid #f1f5f9;">
                                {{ $ticket->message }}
                            </p>

                            @if($ticket->admin_reply)
                                <div style="margin-top:12px; padding:12px 14px; background:color-mix(in srgb, var(--brand-primary, #1e3a8a) 4%, #ffffff); border:1px solid color-mix(in srgb, var(--brand-primary, #1e3a8a) 18%, #ffffff); border-radius:10px;">
                    ...
                    @empty
                        <div style="background:#ffffff; border:1px dashed var(--border, #cbd5e1); border-radius:14px; padding:36px 20px; text-align:center;">
                            <div style="width:54px; height:54px; margin:0 auto 12px auto; border-radius:50%; background:#f1f5f9; display:grid; place-items:center; font-size:1.6rem; color:var(--text-muted);">
                                💬
                            </div>
                            ...
                            <div style="display:flex; flex-wrap:wrap; justify-content:center; gap:8px;">
                                <span style="font-size:0.75rem; padding:4px 10px; background:#f1f5f9; color:var(--text-secondary); border-radius:20px; font-weight:600;">📦 Order Tracking</span>
                                <span style="font-size:0.75rem; padding:4px 10px; background:#f1f5f9; color:var(--text-secondary); border-radius:20px; font-weight:600;">💳 Payment &amp; UTR</span>
                                <span style="font-size:0.75rem; padding:4px 10px; background:#f1f5f9; color:var(--text-secondary); border-radius:20px; font-weight:600;">🚚 Shipping Info</span>
                            </div>
                        </div>
                    @endforelse
