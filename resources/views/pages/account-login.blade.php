    ...
    <div class="container customer-auth-shell">
        ...
        <div class="card customer-auth-card">
                ...
                <form method="POST" action="{{ route('account.login.submit') }}">
                    ...
                    <div class="form-group"><label for="login-password">Password</label><input id="login-password" type="password" name="password" required autocomplete="current-password" placeholder="Enter your password" class="form-control"></div>
                    <button type="submit" class="btn btn-primary" style="width:100%;">Login</button>
                </form>
                <p class="customer-auth-switch">New customer? <a href="{{ route('account.register.form') }}">Create an account</a></p>
        </div>
    </div>
</section>
@endsection
