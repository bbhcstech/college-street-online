<div class="nav-group">
    ...
    <a href="{{ route('admin.dashboard') }}" class="nav-link {{ $active === 'dashboard' ? 'active' : '' }}"><span
...
<div class="nav-group">
    ...
    <a href="{{ route('admin.publishers.index') }}"
        class="nav-link {{ $active === 'publishers' ? 'active' : '' }}"><span
            class="nav-icon">&#128100;</span><span>Publishers</span></a>
    <a href="{{ route('admin.books.index') }}" class="nav-link {{ $active === 'books' ? 'active' : '' }}"><span
            class="nav-icon">&#128214;</span><span>Books</span></a>
    <a href="{{ route('admin.categories.index') }}"
        class="nav-link {{ $active === 'categories' ? 'active' : '' }}"><span
            class="nav-icon">&#127991;</span><span>Categories &amp; Authors</span></a>
    <a href="{{ route('admin.coupons.index') }}" class="nav-link {{ $active === 'coupons' ? 'active' : '' }}"><span
