...
@section('content')
    ...
    <div class="newsletter-layout">
        <section class="a-card newsletter-compose-card">
        ...
        <aside class="a-card newsletter-preview-card">
            <div class="newsletter-card-head">
                <div class="newsletter-icon">◫</div>
                <div>
                    <h3>Email preview</h3>
                    <p>Approximate subscriber view</p>
                </div>
            </div>
    ...
    <section class="a-card newsletter-list-card">
        <div class="newsletter-card-head">
            <div class="newsletter-icon">♙</div>
            <div>
