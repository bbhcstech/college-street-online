...
<div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
    <div>
        ...
        <h2 style="font-size: 1.75rem; font-weight: 800; color: #0f172a; margin: 4px 0;">Edit Administrator</h2>
        <p style="color: #64748b; font-size: 0.9rem; margin: 0;">Update account profile details and security permissions for {{ $administrator->name }}.</p>
    </div>
...
<div class="a-card" style="padding: 32px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); max-width: 900px;">
    <form method="POST" action="{{ route('admin.administrators.update', $administrator) }}">
        ...
        <div style="margin-bottom: 28px; padding-bottom: 20px; border-bottom: 1px solid #f1f5f9;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
                <div class="a-form-group">
                    ...
                    <input id="admin-name" class="a-input" name="name" value="{{ old('name', $administrator->name) }}" required style="height: 44px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 14px; font-size: 0.95rem;">
                ...
                <div class="a-form-group">
                    ...
                    <input id="admin-email" class="a-input" type="email" name="email" value="{{ old('email', $administrator->email) }}" required style="height: 44px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 14px; font-size: 0.95rem;">
        ...
        <div style="margin-bottom: 28px;">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px;">
                <span style="font-size: 1.2rem;">🔑</span>
                <h3 style="font-size: 1.1rem; font-weight: 800; color: #0f172a; margin: 0;">New Password <span style="font-weight: 400; color: #64748b; font-size: 0.88rem;">(Optional)</span></h3>
            </div>

            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
                <div class="a-form-group">
                    <label for="admin-password" style="font-weight: 700; font-size: 0.88rem; color: #334155; margin-bottom: 6px; display: block;">New Password</label>
                    <input id="admin-password" class="a-input" type="password" name="password" minlength="8" placeholder="Leave blank to keep current password" style="height: 44px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 14px; font-size: 0.95rem;">
                    <small style="color: #64748b; font-size: 0.8rem; margin-top: 4px; display: block;">Minimum 8 characters if changing.</small>
                ...
                <div class="a-form-group">
                    <label for="admin-password-confirmation" style="font-weight: 700; font-size: 0.88rem; color: #334155; margin-bottom: 6px; display: block;">Confirm New Password</label>
                    <input id="admin-password-confirmation" class="a-input" type="password" name="password_confirmation" placeholder="••••••••" style="height: 44px; border-radius: 8px; border: 1px solid #cbd5e1; padding: 0 14px; font-size: 0.95rem;">
                </div>
            </div>
        </div>
