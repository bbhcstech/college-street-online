...
<div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
    <div>
        <p style="color: var(--a-text-muted); font-size: 0.9rem; margin: 0;">Create a new administrator account and assign system access permissions.</p>
    </div>
...
<div class="a-card" style="padding: 32px; border-radius: 12px; background: var(--a-surface); border: 1px solid var(--a-border); box-shadow: var(--a-shadow-sm); max-width: 900px;">
    <form method="POST" action="{{ route('admin.administrators.store') }}">
        ...
        <div style="margin-bottom: 28px; padding-bottom: 20px; border-bottom: 1px solid var(--a-border);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
                <div class="a-form-group">
                    ...
                    <input id="admin-name" class="a-input" name="name" value="{{ old('name') }}" placeholder="e.g. John Doe" required style="height: 44px; border-radius: 8px; border: 1px solid var(--a-border); background: var(--a-surface-alt); color: var(--a-text); padding: 0 14px; font-size: 0.95rem;">
                ...
                <div class="a-form-group">
                    ...
                    <input id="admin-email" class="a-input" type="email" name="email" value="{{ old('email') }}" placeholder="e.g. admin@collegestreetonline.com" required style="height: 44px; border-radius: 8px; border: 1px solid var(--a-border); background: var(--a-surface-alt); color: var(--a-text); padding: 0 14px; font-size: 0.95rem;">
        ...
        <div style="margin-bottom: 28px;">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px;">
                <span style="font-size: 1.2rem;">🔑</span>
                <h3 style="font-size: 1.1rem; font-weight: 800; color: var(--a-text); margin: 0;">Security Credentials</h3>
            </div>

            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
                <div class="a-form-group">
                    <label for="admin-password" style="font-weight: 700; font-size: 0.88rem; color: var(--a-text); margin-bottom: 6px; display: block;">Account Password</label>
                    <input id="admin-password" class="a-input" type="password" name="password" minlength="8" required placeholder="••••••••" style="height: 44px; border-radius: 8px; border: 1px solid var(--a-border); background: var(--a-surface-alt); color: var(--a-text); padding: 0 14px; font-size: 0.95rem;">
                    <small style="color: var(--a-text-muted); font-size: 0.8rem; margin-top: 4px; display: block;">Minimum 8 characters required.</small>
                ...
                <div class="a-form-group">
                    <label for="admin-password-confirmation" style="font-weight: 700; font-size: 0.88rem; color: var(--a-text); margin-bottom: 6px; display: block;">Confirm Password</label>
                    <input id="admin-password-confirmation" class="a-input" type="password" name="password_confirmation" required placeholder="••••••••" style="height: 44px; border-radius: 8px; border: 1px solid var(--a-border); background: var(--a-surface-alt); color: var(--a-text); padding: 0 14px; font-size: 0.95rem;">
                </div>
            </div>
        </div>
