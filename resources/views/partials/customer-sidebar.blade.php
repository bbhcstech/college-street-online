@auth
    @if(auth()->user()->isCustomer())
        ...
        <aside class="customer-drawer-sidebar" data-customer-sidebar>
            <div class="customer-sidebar-header">
                ...
                <button type="button" class="customer-sidebar-close" data-customer-sidebar-close aria-label="Close sidebar">&times;</button>
            </div>
            <nav class="customer-sidebar-nav">
                ...
                <a href="{{ route('account.notifications') }}" class="{{ request()->routeIs('account.notifications') ? 'active' : '' }}">
                    ...
                    <span>Notifications @if(auth()->user()->unreadNotifications()->count())<b class="customer-notification-count">{{ auth()->user()->unreadNotifications()->count() }}</b>@endif</span>
                </a>
                ...
                <a href="{{ route('account.support') }}" class="{{ request()->routeIs('account.support') ? 'active' : '' }}">
